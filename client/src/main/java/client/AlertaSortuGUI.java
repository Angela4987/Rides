...
public class AlertaSortuGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public AlertaSortuGUI(final Bidaiaria b) {			// GEHITU final
		...
		btnSortu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					facade.alertaSortu(nondik,nora,toXMLGregorianCalendar(jCalendar1.getDate()),b);
				...
				} catch (AlertaAlreadyExistException_Exception e2) {
	...
	private void datuakZuzenak(String nondik, String nora) throws IsEmptyException, IllegalArgumentException {
		...
		if (!nondik.matches("[a-zA-Záéíóú�?É�?ÓÚñÑ ]+") || !nora.matches("[a-zA-Záéíóú�?É�?ÓÚñÑ ]+")) {
