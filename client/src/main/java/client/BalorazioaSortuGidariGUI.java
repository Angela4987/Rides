...
public class BalorazioaSortuGidariGUI extends JFrame {
	...
	private JComboBox<String> comboBidaia;			// ALDATU Integer -> String
	private DefaultComboBoxModel<String> BidaiaBox = new DefaultComboBoxModel<String>();		// ALDATU Integer -> String
	 ...
	 * Create the frame.
	 */
	public BalorazioaSortuGidariGUI(final Driver g) {			// GEHITU final
		...
		comboBidaiari = new JComboBox<String>();		// ALDATU Integer -> String
		...
		comboBidaia = new JComboBox<String>();
		...
		btnBidali.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					Integer bidaiZenbaki = Integer.parseInt(BidaiaBox.getSelectedItem().toString());	// ALDATU (Integer) -> Integer.parseInt
