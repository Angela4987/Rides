...
public class RegisterGUI extends JFrame {
		...
		btnErregistratu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					// ALDATU jaiotzeData -> toXMLGregorianCalendar(jaiotzeData)
					if(facade.erregistratu(txtIzena.getText(), txtAbizena.getText(), toXMLGregorianCalendar(jaiotzeData), sexua, erabiltzaileMota, txtEmail.getText(), new String(pasahitzafield.getPassword()))) {
	...
	private void datuakZuzenak(String izena, String abizena, Date jaiotzeData, String sexua, String erabiltzaileMota, String email, String pasahitza) throws IllegalArgumentException, AdinTxikikoException, IsEmptyException {
		...
		if (!izena.matches("[a-zA-Záéíóú�?É�?ÓÚñÑ ]+") || !abizena.matches("[a-zA-Záéíóú�?É�?ÓÚñÑ ]+")) {
