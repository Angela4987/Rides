...
public class CreateRideGUI extends JFrame {
	...
	private List<XMLGregorianCalendar> datesWithEventsCurrentMonth;		// ALDATU Date -> XMLGregorianCalendar
	...
	public CreateRideGUI(Driver driver) {
		...
		final BLFacade facade = MainGUI.getBusinessLogic();		// GEHITU final
		
		// ALDATU jCalendar.getDate() -> toXMLGregorianCalendar(jCalendar.getDate())
		datesWithEventsCurrentMonth=facade.getThisMonthDatesWithRides("a","b",toXMLGregorianCalendar(jCalendar.getDate()));		
		...
		comboBoxCars.setBounds(126, 149, 130, 22);
	...
	private void jButtonCreate_actionPerformed(ActionEvent e) {
		...
		if (error!=null) 
			...
			try {
				...
				// ALDATU UtilDate.trim(jCalendar.getDate()) -> toXMLGregorianCalendar(UtilDate.trim(jCalendar.getDate()))
				Ride r=facade.createRide(fieldOrigin.getText(), fieldDestination.getText(), toXMLGregorianCalendar(UtilDate.trim(jCalendar.getDate())), inputSeats, price, driver.getEmail());
